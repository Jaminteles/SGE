...
-- CreateEnum
CREATE TYPE "SettingScope" AS ENUM ('FINANCIAL', 'FISCAL', 'GENERAL');
...
CREATE TABLE "categories" (
    ...
    "companyId" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "scope" "SettingScope" NOT NULL DEFAULT 'FINANCIAL',
    "parentId" TEXT,
    "status" "RecordStatus" NOT NULL DEFAULT 'ACTIVE',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "company_settings" (
    "id" TEXT NOT NULL,
    "companyId" TEXT NOT NULL,
    "scope" "SettingScope" NOT NULL DEFAULT 'GENERAL',
    "key" TEXT NOT NULL,
    "value" TEXT NOT NULL,
    "description" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE UNIQUE INDEX "categories_companyId_scope_name_key" ON "categories"("companyId", "scope", "name");

-- CreateIndex
CREATE INDEX "cost_centers_companyId_status_idx" ON "cost_centers"("companyId", "status");

-- CreateIndex
CREATE UNIQUE INDEX "cost_centers_companyId_code_key" ON "cost_centers"("companyId", "code");

-- CreateIndex
CREATE UNIQUE INDEX "company_settings_companyId_scope_key_key" ON "company_settings"("companyId", "scope", "key");

-- CreateIndex
CREATE INDEX "approval_thresholds_companyId_operation_status_idx" ON "approval_thresholds"("companyId", "operation", "status");
...
-- AddForeignKey
ALTER TABLE "approval_thresholds" ADD CONSTRAINT "approval_thresholds_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "approval_thresholds" ADD CONSTRAINT "approval_thresholds_requiredRoleId_fkey" FOREIGN KEY ("requiredRoleId") REFERENCES "roles"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
